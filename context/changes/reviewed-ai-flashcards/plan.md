...
- [ ] 2.3 `curl` POST with valid text returns ≤15 pending flashcards persisted for the authenticated user
- [ ] 2.4 POST with 10-char text returns a 400 validation error
- [ ] 2.5 Simulated AI failure returns a JSON error, and no rows are inserted
